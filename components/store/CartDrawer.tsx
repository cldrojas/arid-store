    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between border-b border-edge px-5 py-4">
          ...
          <button
            onClick={onClose}
            className="rounded-md p-1 text-content-muted hover:text-content-secondary"
        ...
        {items.length > 0 && (
          <div className="border-t border-edge px-5 py-4 space-y-3">
            ...
            <Link
              href="/carrito"
              onClick={onClose}
              className="flex w-full items-center justify-center rounded-lg bg-accent px-4 py-2.5 text-sm font-medium text-accent-content hover:bg-accent-hover transition-colors"
            >
              Ir al carrito
            </Link>
          </div>
